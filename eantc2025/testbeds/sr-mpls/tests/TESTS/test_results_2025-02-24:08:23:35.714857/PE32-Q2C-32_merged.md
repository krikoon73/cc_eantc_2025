...
IS-IS Instance: IGP VRF: default
  IS-IS Level 2 Link State Database
    ...
    Arista-PE32-Q2C-32.00-00       780  32665   889    592 L2  0000.0000.0032.00-00  <>
      ...
      Time remaining until refresh: 589 s
      NLPID: 0xCC(IPv4) 0x8E(IPv6)
    ...
    0000.0000.0128.00-00       1917  42612   807    401 L2  0000.0000.0128.00-00  <>
      ...
      Router Capabilities: Router Id: 10.0.0.128 Flags: []
        ...
        SR Capability: Flags: [I]
          SRGB Base: 20000 Range: 2000
        Algorithms:  0, 128
    Juniper-131-JCNR.00-00       551   5367   669    447 L2  0000.0000.0131.00-00  <>
      Remaining lifetime received: 1199 s Modified to: 1200 s
      NLPID: 0xCC(IPv4) 0x8E(IPv6)
    ...
    Juniper-179-ACX7024.00-00       720  31209   869    543 L2  0000.0000.0179.00-00  <>
      Remaining lifetime received: 1199 s Modified to: 1200 s
      NLPID: 0xCC(IPv4) 0x8E(IPv6)
  ...
  IS-IS Level 2 Link State Database
    ...
    Arista-Spine3-Q2A-30.00-00      1527   2347   881   1092 L2  0000.0000.0030.00-00  <>
      ...
      Router Capabilities: Router Id: 10.0.0.30 Flags: []
        ...
        Flex Algo: Algorithm: 129 Metric: TE Metric (2) Calc: SPF (0) Prio: 255
        Flex Algo: Algorithm: 128 Metric: Min Unidirectional Delay Metric (1) Calc: SPF (0) Prio: 255
    Arista-Spine3-Q2A-30.00-01       909   7244  1016   1086 L2  0000.0000.0030.00-01  <>
      Remaining lifetime received: 1199 s Modified to: 1200 s
      IS Neighbor          : Ciena-5134-72.00    Metric: 1
        IPv4 Neighbor Address: 20.30.72.72
        IPv4 Interface Address: 20.30.72.30
    ...
    Ciena-5134-72.00-00         315  30789   391    336 L2  0000.0000.0072.00-00  <>
      ...
      Router Capabilities: Router Id: 10.0.0.72 Flags: []
        SR Capability: Flags: [I]
          SRGB Base: 20000 Range: 2000
        Algorithms:  0
    Ericsson_84_R6678.00-00       828  16588  1087    324 L2  0000.0000.0084.00-00  <>
      Remaining lifetime received: 1199 s Modified to: 1200 s
      NLPID: 0xCC(IPv4) 0x8E(IPv6)
      Hostname: Ericsson_84_R6678
    ...
    Juniper-131-JCNR.00-00       551   5367   668    447 L2  0000.0000.0131.00-00  <>
      ...
      Router Capabilities: Router Id: 10.0.0.131 Flags: []
        ...
        Algorithms:  0, 1, 128, 129, 130
      Unsupported TLV: Type: 14 Length: 2
    Juniper-156-PTX10002-36QDD.00-00       612  53877  1169   1014 L2  0000.0000.0156.00-00  <>
      Remaining lifetime received: 1199 s Modified to: 1200 s
      NLPID: 0xCC(IPv4) 0x8E(IPv6)
      Hostname: Juniper-156-PTX10002-36QDD
      ...
      Shared Risk Link Group:  Neighbor Arista-Spine3-Q2A-30.00 (Numbered)
        ...
        Group ID: 2
      Unsupported TLV: Type: 14 Length: 2
    Juniper-175-ACX7100-48L.00-00       972  38906   998   1178 L2  0000.0000.0175.00-00  <>
      Remaining lifetime received: 1198 s Modified to: 1200 s
      NLPID: 0xCC(IPv4) 0x8E(IPv6)
      Hostname: Juniper-175-ACX7100-48L
      ...
      Router Capabilities: Router Id: 10.0.0.175 Flags: []
        ...
        Flex Algo: Algorithm: 128 Metric: Min Unidirectional Delay Metric (1) Calc: SPF (0) Prio: 0
          Flags: [M] 0x80
      Unsupported TLV: Type: 14 Length: 2
    Juniper-175-ACX7100-48L.00-01       842  37591   339   1107 L2  0000.0000.0175.00-01  <>
      Remaining lifetime received: 1198 s Modified to: 1200 s
      IS Neighbor          : Ericsson_84_R6678.00 Metric: 10
        IPv4 Neighbor Address: 20.84.175.84
        IPv4 Interface Address: 20.84.175.175
...
Response sequence number: 0
Number of times path updated: 1
Last updated: 2 days, 23:15:17 ago
Next Hop Interface
-------- ---------
...
Response sequence number: 0
Number of times path updated: 1
Last updated: 2 days, 17:53:17 ago
Metric: 20
Next Hop      Interface
------------- ---------
20.32.175.175 Ethernet5
...
BGP neighbor is 10.0.0.30, remote AS 64512, internal link
 Description: Arista-Spine30
  ...
  Last read 00:00:19, last write 00:00:46
  ...
  Message Statistics:
    ...
    Notifications:                   4         0
    Updates:                        70      1352
    Keepalives:                  11206     11026
    Enhanced Route Refresh:          0         0
    Begin of Route Refresh:          0         0
    End of Route Refresh:            0         0
    Total messages:              11285     12383
  Prefix Statistics:
...
BGP neighbor is 10.0.0.175, remote AS 64512, internal link
 Description: Juniper_175
  ...
  Inherits configuration from and member of peer-group IBGP_CLIENT_PEER
  Last read 00:00:07, last write 00:00:12
  ...
  Message Statistics:
    ...
    Updates:              968      1851
    Keepalives:         22611     20322
    Route Refresh:          0         0
    Total messages:     23736     22440
  Prefix Statistics:
                                   Sent      Rcvd     Best Paths     Best ECMP Paths
    IPv4 Unicast:                     0         0              0                   0
    VPN-IPv4:                         4        33             29                   0
