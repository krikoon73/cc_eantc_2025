...
Neighbor Status Codes: m - Under maintenance
  ...
  ANET.IPV4                20.200.203.200 4 65000            154       141    0    0 01:53:38 Estab   19     19
```
...
Neighbor Status Codes: m - Under maintenance
  Description              Neighbor    V AS           MsgRcvd   MsgSent  InQ OutQ  Up/Down State   PfxRcd PfxAcc
  ANET.EVPN                100.0.0.200 4 65000            215       151    0    0 01:53:38 Estab   82     82
```
...
1203  1203   VXLAN 10.10.203.254      00aa.aaaa.aaaa  100.0.0.56         Stic
                                                                         ky  
...
20.200.203.200    0:00:25  444c.a873.5c75  Ethernet1
```
...
VRF: tenant-a
Address         Age (sec)  Hardware Addr   Interface
10.10.203.204     1:50:11  444c.a873.5c75  Vlan1203, not learned
```
...
4094  246c.8474.8ddb  EVPN      Vx1  100.0.0.40               1:52:37 ago
4094  2899.3a8f.8f6f  EVPN      Vx1  100.0.0.201              0:39:24 ago
4094  4014.827b.84ab  EVPN      Vx1  100.0.0.42               1:53:11 ago
4094  985d.82a2.04f9  EVPN      Vx1  100.0.0.204              1:53:39 ago
4094  985d.82c4.0271  EVPN      Vx1  100.0.0.206              0:40:49 ago
4094  c407.780a.9f31  EVPN      Vx1  100.0.0.22               1:52:12 ago
...
4094    0001.0000.0056    DYNAMIC     Vx1        0       1:31:13 ago
4094    00aa.aaaa.aaaa    STATIC      Router
4094    246c.8474.8ddb    DYNAMIC     Vx1        0       1:52:37 ago
4094    2899.3a8f.8f6f    DYNAMIC     Vx1        0       0:39:24 ago
4094    4014.827b.84ab    DYNAMIC     Vx1        0       1:53:11 ago
4094    985d.82a2.04f9    DYNAMIC     Vx1        0       1:53:39 ago
4094    985d.82c4.0271    DYNAMIC     Vx1        0       0:40:50 ago
4094    c407.780a.9f31    DYNAMIC     Vx1        0       1:52:12 ago
...
4094                            100.0.0.56      100.0.0.204     100.0.0.206    
```
...
EVPN instance: VLAN 1203
  ...
  Local ethernet segment:
    ESI: 0000:0000:0000:0203:0204
      ...
      Designated forwarder: 100.0.0.56
...
----  ---------------  ----------------------------------------
1203  *                100.0.0.56(IR)
1301  *                100.0.0.201(IR), 100.0.0.22(IR),
                       100.0.0.40(IR), 100.0.0.42(IR),
                       100.0.0.56(IR)
1302  *                100.0.0.201(IR), 100.0.0.22(IR),
                       100.0.0.40(IR), 100.0.0.42(IR),
                       100.0.0.56(IR)
1303  *                100.0.0.201(IR), 100.0.0.22(IR),
                       100.0.0.56(IR)
1304  *                100.0.0.201(IR), 100.0.0.22(IR),
                       100.0.0.56(IR)
4094  *                100.0.0.206(IR), 100.0.0.56(IR)
```
...
Vlan1203 is up
  ...
  General query timer expiry: 0:00:08
...
Vlan1302 is up
  ...
  Startup query interval: 312 deciseconds
  Startup query count: 2
  General query timer expiry: 0:00:50
  Multicast groups joined:
Vlan1303 is up
  IGMP on this interface: enabled
  ...
  Startup query interval: 312 deciseconds
  Startup query count: 2
  General query timer expiry: 0:00:52
  Multicast groups joined:
Vlan1304 is up
  IGMP on this interface: enabled
...
Neighbor Address  Interface  Uptime    Expires   Mode    Transport  
20.200.203.200    Ethernet1  01:53:41  00:01:24  sparse  datagram
```
