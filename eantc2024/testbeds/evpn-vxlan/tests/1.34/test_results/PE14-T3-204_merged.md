...
Neighbor Status Codes: m - Under maintenance
  ...
  ANET.IPV4                20.200.204.200 4 65000            157       138    0    0 01:53:38 Estab   19     19
```
...
Neighbor Status Codes: m - Under maintenance
  Description              Neighbor    V AS           MsgRcvd   MsgSent  InQ OutQ  Up/Down State   PfxRcd PfxAcc
  ANET.EVPN                100.0.0.200 4 65000            225       144    0    0 01:53:38 Estab   89     89
```
...
20.200.204.200    0:00:17  444c.a873.5c75  Ethernet1
```
...
4094  246c.8474.8ddb  EVPN      Vx1  100.0.0.40               1:52:36 ago
4094  2899.3a8f.8f6f  EVPN      Vx1  100.0.0.201              0:39:24 ago
4094  3838.a621.e82f  EVPN      Vx1  100.0.0.203              1:53:39 ago
...
4094    3838.a621.e82f    DYNAMIC     Vx1        0       1:53:39 ago
...
4094                            100.0.0.56      100.0.0.203     100.0.0.206    
```
...
Vlan1203 is up
  ...
  General query timer expiry: 0:00:01
...
Vlan1302 is up
  ...
  Startup query interval: 312 deciseconds
  Startup query count: 2
  General query timer expiry: 0:00:57
  Multicast groups joined:
Vlan1303 is up
  IGMP on this interface: enabled
...
Neighbor Address  Interface  Uptime    Expires   Mode    Transport  
20.200.204.200    Ethernet1  01:53:42  00:01:24  sparse  datagram
```
