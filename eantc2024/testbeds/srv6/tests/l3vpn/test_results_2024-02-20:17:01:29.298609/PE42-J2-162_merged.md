...
Uptime: 5 hours and 44 minutes
Total memory: 8099732 kB
Free memory: 5010416 kB
...
```text
Last table change time   : 3:39:46 ago
...
srv6      default  Cisco344-N57B1   L1   Ethernet20         P2P               UP    26          00                  
```
...
Neighbor Status Codes: m - Under maintenance
  ...
  2002::353 4 1                627       334    0    0 04:32:03 Estab   0      0
```
...
Type 'SRv6 Transport', index 52, endpoint fcbb:0:20::/48, forwarding None
   via fe80::f24b:3aff:fe21:9e0f, 'Ethernet10' SRv6, source 2002::162

Type 'SRv6 Transport', index 55, endpoint fcbb:0:1199::/48, forwarding None
   via fe80::eaf:31ff:feca:1104, 'Ethernet20' SRv6, source 2002::162

Type 'SRv6 Transport', index 57, endpoint fcbb:0:59::/48, forwarding None
   via fe80::f24b:3aff:fe21:9e0f, 'Ethernet10' SRv6, source 2002::162

Type 'SRv6 Transport', index 60, endpoint fcbb:0:1058::/48, forwarding None
   via fe80::eaf:31ff:feca:1104, 'Ethernet20' SRv6, source 2002::162

Type 'SRv6 Transport', index 66, endpoint fcbb:0:352::/48, forwarding None
   via fe80::f24b:3aff:fe21:9e0f, 'Ethernet10' SRv6, source 2002::162

Type 'SRv6 Transport', index 72, endpoint fcbb:0:1011::/48, forwarding None
   via fe80::f24b:3aff:fe21:9e0f, 'Ethernet10' SRv6, source 2002::162
```
...
Codes: C - connected, S - static, K - kernel, O3 - OSPFv3,
 ...
 B I      2001:20:20:225::/64 [200/0]
           via fcbb:0:20::/48, SRv6 Transport tunnel index 52, SRv6 SID fcbb:0:20:e101::
              via fe80::f24b:3aff:fe21:9e0f, Ethernet10
 ...
 B I      2001:20:58:225::/64 [200/0]
           via fcbb:0:1058::/48, SRv6 Transport tunnel index 60, SRv6 SID fcbb:0:1058:e018::
              via fe80::eaf:31ff:feca:1104, Ethernet20
 B I      2001:20:59:225::/64 [200/0]
           via fcbb:0:59::/48, SRv6 Transport tunnel index 57, SRv6 SID fcbb:0:59:e020::
              via fe80::f24b:3aff:fe21:9e0f, Ethernet10
 B I      2001:20:153:225::/64 [200/0]
           via fcbb:0:1353::/48, SRv6 Transport tunnel index 5, SRv6 SID fcbb:0:1353:e004::
              via fe80::f24b:3aff:fe21:9e0f, Ethernet10
...
IS-IS Instance: srv6 VRF: default
  IS-IS Level 1 Link State Database
    ...
    h3c_29_S12500R-2L.00-00       152  14639  1024    430 L1 <>
    ...
    Ericsson_6676_49.00-00       199  41363   988    486 L1 <>
      NLPID: 0xCC(IPv4) 0x8E(IPv6)
      ...
      Router Capabilities: Router Id: 10.0.0.49 Flags: []
        SRv6 Capability: Flags: []
        Algorithms:  0
    PE42-J2-162.00-00           123  13309   809    250 L1 <>
      LSP generation remaining wait time: 0 ms
      Time remaining until refresh: 509 s
      NLPID: 0x8E(IPv6)
      ...
      Router Capabilities: Router Id: 100.0.0.162 Flags: []
        ...
        SRv6 Capability: Flags: []
    huawei_199.00-00            184  27249  1164    694 L1 <>
      NLPID: 0x8E(IPv6)
      Hostname: huawei_199
      Area addresses: 49.0001
      Topology: 0 (IPv4)
      ...
      Router Capabilities: Router Id: 0.0.0.0 Flags: []
        SRv6 Capability: Flags: []
    JNPR-302-MX204.00-00        124  57549   431    351 L1 <>
    ...
    JNPR-310-ACX7100-48L.00-00       529  36892   534   1205 L2 <DefaultAtt>
      NLPID: 0x8E(IPv6)
      ...
      Router Capabilities: Router Id: 10.0.1.10 Flags: []
        ...
        Algorithms:  0, 1
      Unsupported TLV: Type: 14 Length: 2
    JNPR-310-ACX7100-48L.00-01       253  51724   534    232 L2 <>
      ...
      SRv6 Locator: fcbb:0:1310::/48 Topology: 0
        ...
        SRv6 SID End with NEXT-CSID PSP USP USD
          SID : fcbb:0:1310::
    ZTE_338_ZXR10_M6000-4SE.00-00       227  56437   740    501 L2 <>
      NLPID: 0xCC(IPv4) 0x8E(IPv6)
      ...
      Router Capabilities: Router Id: 10.0.1.38 Flags: []
        ...
        Algorithms:  0, 1
    Cisco344-N57B1.00-00        125  53043  1056    418 L1 <>
      NLPID: 0x8E(IPv6)
      ...
      Router Capabilities: Router Id: 0.0.0.0 Flags: []
        ...
        Algorithms:  0, 1
      Unsupported TLV: Type: 14 Length: 2
    Cisco353-8201-24H8FH.00-00       555  38293   521   1185 L2 <DefaultAtt>
      Remaining lifetime received: 1198 s Modified to: 1200 s
      NLPID: 0x8E(IPv6)
      ...
      Router Capabilities: Router Id: 0.0.0.0 Flags: []
        ...
        Algorithms:  0, 1
      Unsupported TLV: Type: 14 Length: 2
    Nokia_58-SR1-3-SRv6.00-00       263  61481 63667    356 L2 <DefaultAtt>
      NLPID: 0xCC(IPv4) 0x8E(IPv6)
      ...
      Router Capabilities: Router Id: 10.0.0.58 Flags: []
        ...
        SRv6 Capability: Flags: []
        Algorithms:  0
    Nokia_58-SR1-3-SRv6.00-01       237   7810 64155   1347 L2 <>
      ...
      SRv6 Locator: fcbb:0:1058::/48 Topology: 0
        ...
        SRv6 SID End with NEXT-CSID PSP USD
          ...
          SID structure: Block length: 32 Node length: 16
                         Function length: 0 Argument length: 80
    Keys-Ixia-419.00-00          41  40568  1087    351 L2 <DefaultAtt>
...
Ethernet1 is down, line protocol is notpresent (notconnect)
  ...
  Down 5 hours, 40 minutes, 20 seconds
  Loopback Mode : None
  1 link status changes since last clear
  Last clearing of "show interface" counters 5:44:48 ago
...
Ethernet5 is down, line protocol is down (notconnect)
  ...
  Down 5 hours, 40 minutes, 8 seconds
  Loopback Mode : None
  1 link status changes since last clear
  Last clearing of "show interface" counters 5:44:48 ago
  5 seconds input rate 0 bps (0.0% with framing overhead), 0 packets/sec
...
Ethernet10 is up, line protocol is up (connected)
  ...
  Full-duplex, 10Gb/s, auto negotiation: off, uni-link: disabled
  Up 5 hours, 39 minutes, 54 seconds
  Loopback Mode : None
  2 link status changes since last clear
  Last clearing of "show interface" counters 5:44:48 ago
  5 seconds input rate 16.6 Mbps (0.2% with framing overhead), 2010 packets/sec
  5 seconds output rate 826 bps (0.0% with framing overhead), 1 packets/sec
     15889957 packets input, 14128359776 bytes
     Received 0 broadcasts, 7143 multicast
     0 runts, 0 giants
     0 input errors, 0 CRC, 0 alignment, 0 symbol, 0 input discards
     0 PAUSE input
     8651734 packets output, 8875854605 bytes
     Sent 0 broadcasts, 6243 multicast
     0 output errors, 0 collisions
     0 late collision, 0 deferred, 0 output discards
     0 PAUSE output
...
Ethernet12 is up, line protocol is up (connected)
  ...
  Ethernet MTU 10218 bytes, Ethernet MRU 10240 bytes, BW 10000000 kbit
  Full-duplex, 10Gb/s, auto negotiation: off, uni-link: disabled
  Up 5 hours, 39 minutes, 57 seconds
  Loopback Mode : None
  2 link status changes since last clear
  Last clearing of "show interface" counters 5:44:48 ago
  5 seconds input rate 17 bps (0.0% with framing overhead), 0 packets/sec
  5 seconds output rate 509 bps (0.0% with framing overhead), 1 packets/sec
     6489009 packets input, 5899200610 bytes
     Received 12 broadcasts, 792 multicast
     0 runts, 0 giants
     0 input errors, 0 CRC, 0 alignment, 0 symbol, 0 input discards
     0 PAUSE input
     8378119 packets output, 8316619315 bytes
     Sent 8 broadcasts, 11003 multicast
     0 output errors, 0 collisions
     0 late collision, 0 deferred, 0 output discards
     0 PAUSE output
...
Ethernet20 is up, line protocol is up (connected)
  ...
  2 link status changes since last clear
  Last clearing of "show interface" counters 5:44:48 ago
  5 seconds input rate 425 bps (0.0% with framing overhead), 1 packets/sec
  5 seconds output rate 16.3 Mbps (0.2% with framing overhead), 1975 packets/sec
     8272867 packets input, 8480779834 bytes
     Received 0 broadcasts, 4333 multicast
     0 runts, 0 giants
     0 input errors, 0 CRC, 0 alignment, 0 symbol, 0 input discards
     0 PAUSE input
     10427156 packets output, 8503245392 bytes
     Sent 0 broadcasts, 6952 multicast
     0 output errors, 0 collisions
     0 late collision, 0 deferred, 0 output discards
     0 PAUSE output
...
Ethernet39 is up, line protocol is up (connected)
  ...
  Last clearing of "show interface" counters 5:44:48 ago
  5 seconds input rate 30 bps (0.0% with framing overhead), 0 packets/sec
  5 seconds output rate 504 bps (0.0% with framing overhead), 1 packets/sec
     714 packets input, 176590 bytes
     Received 8 broadcasts, 706 multicast
     0 runts, 0 giants
     0 input errors, 0 CRC, 0 alignment, 0 symbol, 0 input discards
     0 PAUSE input
     10756 packets output, 1411814 bytes
     Sent 8 broadcasts, 10748 multicast
     0 output errors, 0 collisions
     0 late collision, 0 deferred, 0 output discards
     0 PAUSE output
Ethernet40 is up, line protocol is up (connected)
  ...
  5 seconds input rate 30 bps (0.0% with framing overhead), 0 packets/sec
  5 seconds output rate 504 bps (0.0% with framing overhead), 1 packets/sec
     677 packets input, 173453 bytes
     Received 0 broadcasts, 677 multicast
     0 runts, 0 giants
     0 input errors, 0 CRC, 0 alignment, 0 symbol, 0 input discards
     0 PAUSE input
     10786 packets output, 1414090 bytes
     Sent 16 broadcasts, 10770 multicast
     0 output errors, 0 collisions
     0 late collision, 0 deferred, 0 output discards
     0 PAUSE output
...
Loopback0 is up, line protocol is up (connected)
  ...
  Up 5 hours, 43 minutes, 11 seconds
Management1 is up, line protocol is up (connected)
  ...
  Up 5 hours, 43 minutes, 5 seconds
  Loopback Mode : None
  6 link status changes since last clear
  Last clearing of "show interface" counters 5:44:48 ago
  5 seconds input rate 17.9 kbps (0.0% with framing overhead), 18 packets/sec
  5 seconds output rate 60.8 kbps (0.0% with framing overhead), 12 packets/sec
     1162894 packets input, 1642377437 bytes
     Received 49825 broadcasts, 17696 multicast
     0 runts, 0 giants
     0 input errors, 0 CRC, 0 alignment, 0 symbol, 0 input discards
     0 PAUSE input
     592954 packets output, 49882028 bytes
     Sent 5 broadcasts, 691 multicast
     0 output errors, 0 collisions
     0 late collision, 0 deferred, 0 output discards
     0 PAUSE output
Vlan20 is up, line protocol is up (connected)
  ...
  Up 4 hours, 34 minutes, 3 seconds
```
...
Et10                   0:05      16.6   0.2%        2       0.0   0.0%        0
...
Et20                   0:05       0.0   0.0%        0      16.3   0.2%        1
