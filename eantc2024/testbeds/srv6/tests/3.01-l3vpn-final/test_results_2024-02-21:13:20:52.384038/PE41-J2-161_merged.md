...
```text
Last table change time   : 3:41:19 ago
...
Type 'SRv6 Transport', index 146, endpoint fcbb:0:316::/48, forwarding None
   via fe80::fa7a:41ff:fe18:8910, 'Ethernet10' SRv6, source 2002::161
```
...
Source Codes:
 ...
 B I      2001:20:116:225::/64 [200/0]
           via fcbb:0:316::/48, SRv6 Transport tunnel index 146, SRv6 SID fcbb:0:316:e003::
              via fe80::fa7a:41ff:fe18:8910, Ethernet10
...
Gateway of last resort is not set
 ...
 B I      20.116.225.0/24 [200/0]
           via fcbb:0:316::/48, SRv6 Transport tunnel index 146, SRv6 SID fcbb:0:316:e002::
              via fe80::fa7a:41ff:fe18:8910, Ethernet10
...
IS-IS Instance: srv6 VRF: default
  IS-IS Level 2 Link State Database
    ...
    h3c_20_CR16010E-F.00-00       583  13758   817    571 L2  0000.0000.0020.00-00  <>
    ...
    h3c_28_S12500R-2L.00-00       272   3283  1185    428 L2  0000.0000.0028.00-00  <>
      NLPID: 0xCC(IPv4) 0x8E(IPv6)
      ...
      Router Capabilities: Router Id: 0.0.0.0 Flags: []
        SRv6 Capability: Flags: []
    huawei_36.00-00             428  23898   800    693 L2  0000.0000.0036.00-00  <>
      NLPID: 0x8E(IPv6)
      Hostname: huawei_36
      Area addresses: 49.0000
      Topology: 0 (IPv4)
      ...
      Router Capabilities: Router Id: 0.0.0.0 Flags: []
        SRv6 Capability: Flags: []
    anet-161-R3.00-00           443  45261   941    250 L2  0000.0000.0161.00-00  <>
      LSP generation remaining wait time: 0 ms
      Time remaining until refresh: 641 s
      NLPID: 0x8E(IPv6)
      ...
      Router Capabilities: Router Id: 100.0.0.161 Flags: []
        ...
        SRv6 Capability: Flags: []
    JNPR-307-ACX7024.00-00       165  26618  1111    343 L2  0000.0000.0307.00-00  <>
      NLPID: 0x8E(IPv6)
    ...
    JNPR-310-ACX7100-48L.00-00       720  21116   685   1235 L2  0000.0000.0310.00-00  <>
      NLPID: 0x8E(IPv6)
      ...
      Router Capabilities: Router Id: 10.0.1.10 Flags: []
        ...
        Algorithms:  0, 1
      Unsupported TLV: Type: 14 Length: 2
    JNPR-310-ACX7100-48L.00-01       414  29547   689    269 L2  0000.0000.0310.00-01  <>
      ...
      SRv6 Locator: fcbb:0:419::/48 Topology: 0
        ...
        SRv6 SID End with NEXT-CSID PSP USD
          SID : fcbb:0:419:11::
    JNPR-316-MX304.00-00        250  50448  1193    369 L2  0000.0000.0316.00-00  <>
      NLPID: 0x8E(IPv6)
      ...
      Router Capabilities: Router Id: 10.0.1.16 Flags: []
        ...
        Algorithms:  0, 1
      Unsupported TLV: Type: 14 Length: 2
    ZTE_336_ZXR10_M6000-8SE.00-00       469  56814  1184    474 L2  0000.0000.0336.00-00  <>
      NLPID: 0xCC(IPv4) 0x8E(IPv6)
      ...
      Router Capabilities: Router Id: 10.0.1.36 Flags: []
        ...
        Algorithms:  0, 1
    Cisco342-9902.00-00         249   8839   510    417 L2  0000.0000.0342.00-00  <>
      NLPID: 0x8E(IPv6)
      ...
      Router Capabilities: Router Id: 0.0.0.0 Flags: []
        ...
        Algorithms:  0, 1
      Unsupported TLV: Type: 14 Length: 2
    Cisco352-N540.00-00         413  37495  1198    435 L2  0000.0000.0352.00-00  <>
      NLPID: 0x8E(IPv6)
      ...
      Router Capabilities: Router Id: 0.0.0.0 Flags: []
        ...
        Algorithms:  0, 1
      Unsupported TLV: Type: 14 Length: 2
    Cisco353-8201-24H8FH.00-00       685  18969   684   1315 L2  0000.0000.0353.00-00  <>
      Remaining lifetime received: 1195 s Modified to: 1200 s
      NLPID: 0x8E(IPv6)
      ...
      Router Capabilities: Router Id: 0.0.0.0 Flags: []
        ...
        Algorithms:  0, 1
      Unsupported TLV: Type: 14 Length: 2
    Nokia_58-SR1-3-SRv6.00-00       454  31044 64893    752 L2  0100.0000.0058.00-00  <>
      NLPID: 0xCC(IPv4) 0x8E(IPv6)
      ...
      Router Capabilities: Router Id: 10.0.0.58 Flags: []
        ...
        SRv6 Capability: Flags: []
        Algorithms:  0
    Nokia_58-SR1-3-SRv6.00-01       325   4461 65016   1259 L2  0100.0000.0058.00-01  <>
      ...
      SRv6 Locator: fcbb:1:1058::/48 Topology: 0
        ...
        SRv6 SID End with NEXT-CSID PSP USD
          ...
          SID structure: Block length: 32 Node length: 16
                         Function length: 0 Argument length: 80
    Nokia-59-IXRe2.00-00        224  35315  1017    488 L2  0100.0000.0059.00-00  <>
      NLPID: 0xCC(IPv4) 0x8E(IPv6)
      ...
      Router Capabilities: Router Id: 10.0.0.59 Flags: []
        ...
        SRv6 Capability: Flags: []
        Algorithms:  0
    Keys-Ixia-419.00-00         149  15291   785    362 L2  3800.0000.0419.00-00  <DefaultAtt>
