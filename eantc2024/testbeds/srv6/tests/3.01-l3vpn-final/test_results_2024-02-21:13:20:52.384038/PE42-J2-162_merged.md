...
```text
Last table change time   : 23:59:09 ago
...
srv6      default  Cisco344-N57B1   L1   Ethernet20         P2P               UP    30          00                  
```
...
Type 'SRv6 Transport', index 202, endpoint fcbb:0:316::/48, forwarding None
   via fe80::f24b:3aff:fe21:9e0f, 'Ethernet10' SRv6, source 2002::162
```
...
Codes: C - connected, S - static, K - kernel, O3 - OSPFv3,
 ...
 B I      2001:20:116:225::/64 [200/0]
           via fcbb:0:316::/48, SRv6 Transport tunnel index 202, SRv6 SID fcbb:0:316:e003::
              via fe80::f24b:3aff:fe21:9e0f, Ethernet10
...
Gateway of last resort is not set
 ...
 B I      20.116.225.0/24 [200/0]
           via fcbb:0:316::/48, SRv6 Transport tunnel index 202, SRv6 SID fcbb:0:316:e002::
              via fe80::f24b:3aff:fe21:9e0f, Ethernet10
...
IS-IS Instance: srv6 VRF: default
  IS-IS Level 1 Link State Database
    ...
    CIEN-11-5169.00-00          591  12038   689    518 L1 <>
      ...
      Router Capabilities: Router Id: 10.0.0.11 Flags: []
        ...
        Algorithms:  0
    h3c_29_S12500R-2L.00-00       262  59915   646    430 L1 <>
      Remaining lifetime received: 1198 s Modified to: 1200 s
      ...
      Router Capabilities: Router Id: 0.0.0.0 Flags: []
        SRv6 Capability: Flags: []
    Ericsson_6676_49.00-00       282  63975   592    486 L1 <>
      NLPID: 0xCC(IPv4) 0x8E(IPv6)
      ...
      Router Capabilities: Router Id: 10.0.0.49 Flags: []
        SRv6 Capability: Flags: []
        Algorithms:  0
    anet-162-R3.00-00           224  11046   959    250 L1 <>
      LSP generation remaining wait time: 0 ms
      Time remaining until refresh: 659 s
      NLPID: 0x8E(IPv6)
      ...
      Router Capabilities: Router Id: 100.0.0.162 Flags: []
        ...
        SRv6 Capability: Flags: []
    huawei_199.00-00            269  60821   902    694 L1 <>
      NLPID: 0x8E(IPv6)
      Hostname: huawei_199
      Area addresses: 49.0001
      Topology: 0 (IPv4)
      ...
      Router Capabilities: Router Id: 0.0.0.0 Flags: []
        SRv6 Capability: Flags: []
    JNPR-302-MX204.00-00        225  63835   781    351 L1 <>
      Remaining lifetime received: 1198 s Modified to: 1200 s
      NLPID: 0x8E(IPv6)
    ...
    JNPR-310-ACX7100-48L.00-00       778  20411  1193   1246 L2 <DefaultAtt>
      Remaining lifetime received: 1198 s Modified to: 1200 s
      NLPID: 0x8E(IPv6)
      ...
      Router Capabilities: Router Id: 10.0.1.10 Flags: []
        ...
        Algorithms:  0, 1
      Unsupported TLV: Type: 14 Length: 2
    JNPR-310-ACX7100-48L.00-01       508  43204  1194    372 L2 <>
      Remaining lifetime received: 1198 s Modified to: 1200 s
      IS Neighbor          : Cisco353-8201-24H8FH.00 Metric: 10
    ...
    ZTE_338_ZXR10_M6000-4SE.00-00       323   7126   645    501 L2 <>
      NLPID: 0xCC(IPv4) 0x8E(IPv6)
      ...
      Router Capabilities: Router Id: 10.0.1.38 Flags: []
        ...
        Algorithms:  0, 1
    Cisco344-N57B1.00-00        219   5450   960    418 L1 <>
      NLPID: 0x8E(IPv6)
      ...
      Router Capabilities: Router Id: 0.0.0.0 Flags: []
        ...
        Algorithms:  0, 1
      Unsupported TLV: Type: 14 Length: 2
    Cisco353-8201-24H8FH.00-00       846  20096   680   1323 L2 <DefaultAtt>
      Remaining lifetime received: 1198 s Modified to: 1200 s
      NLPID: 0x8E(IPv6)
      ...
      Router Capabilities: Router Id: 0.0.0.0 Flags: []
        ...
        Algorithms:  0, 1
      Unsupported TLV: Type: 14 Length: 2
    Nokia_58-SR1-3-SRv6.00-00       357  17932 64319    330 L2 <DefaultAtt>
      NLPID: 0xCC(IPv4) 0x8E(IPv6)
      ...
      Router Capabilities: Router Id: 10.0.0.58 Flags: []
        ...
        SRv6 Capability: Flags: []
        Algorithms:  0
    Nokia_58-SR1-3-SRv6.00-01       362  47994 65525   1050 L2 <>
      ...
      SRv6 Locator: fcbb:0:352::/48 Topology: 0
        ...
        SRv6 SID End with NEXT-CSID PSP USD
          ...
          SID structure: Block length: 32 Node length: 16
                         Function length: 0 Argument length: 80
    Nokia_58-SR1-3-SRv6.00-02        25  34455 65526    665 L2 <>
      ...
      SRv6 Locator: fcbb:0:1058::/48 Topology: 0
        ...
        SRv6 SID End with NEXT-CSID PSP USD
          ...
          SID structure: Block length: 32 Node length: 16
                         Function length: 0 Argument length: 80
    Keys-Ixia-419.00-00         149  15291   781    362 L2 <DefaultAtt>
      Remaining lifetime received: 1198 s Modified to: 1200 s
