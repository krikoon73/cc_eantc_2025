...
```text
  ...
  5 seconds input rate 10.4 Mbps (0.1% with framing overhead), 1304 packets/sec
  5 seconds output rate 10.4 Mbps (0.1% with framing overhead), 1305 packets/sec
  5 seconds input rate 12.4 Mbps (0.1% with framing overhead), 1499 packets/sec
  5 seconds output rate 13.2 Mbps (0.1% with framing overhead), 1598 packets/sec
```

## show lldp neighbors

```text
Last table change time   : 1:46:22 ago
...
srv6      default  Nokia-59-IXRe2   L2   Ethernet20         P2P               UP    19          00                  
```
...
IS-IS Instance: srv6 VRF: default
  IS-IS Level 2 Link State Database
    ...
    h3c_20_CR16010E-F.00-00      3991  12298  1183   1237 L2  0000.0000.0020.00-00  <>
      ...
      Router Capabilities: Router Id: 0.0.0.0 Flags: []
        ...
        Flex Algo: Algorithm: 131 Metric: IGP Metric (0) Calc: SPF (0) Prio: 100
          Flags: [M] 0x80
    h3c_20_CR16010E-F.00-01      1590  27535  1183    276 L2  0000.0000.0020.00-01  <>
      IS Neighbor          : ZTE_336_ZXR10_M6000-8SE.00 Metric: 10
        IPv6 Neighbor Address: 2001:0:20:336::336
        Global IPv6 Interface Address: 2001:0:20:336::20
    h3c_28_S12500R-2L.00-00      1578  10209  1139    964 L2  0000.0000.0028.00-00  <>
      NLPID: 0xCC(IPv4) 0x8E(IPv6)
      ...
      Router Capabilities: Router Id: 0.0.0.0 Flags: []
        ...
        Flex Algo: Algorithm: 128 Metric: Min Unidirectional Delay Metric (1) Calc: SPF (0) Prio: 100
          Flags: [] 0x1
    huawei_36.00-00             221  13465   947   1030 L2  0000.0000.0036.00-00  <>
      NLPID: 0x8E(IPv6)
      Hostname: huawei_36
      Area addresses: 49.0000
      Topology: 0 (IPv4)
      ...
      Router Capabilities: Router Id: 0.0.0.0 Flags: []
        ...
        Flex Algo: Algorithm: 130 Metric: IGP Metric (0) Calc: SPF (0) Prio: 128
          ...
          Flags: [M] 0x80
    huawei_36.00-01             899  30894   947    465 L2  0000.0000.0036.00-01  <>
      ...
      IS Neighbor          : h3c_20_CR16010E-F.00 Metric: 10
        IPv6 Neighbor Address: 2001:0:20:36::20
        Global IPv6 Interface Address: 2001:0:20:36::36
    anet-161-R3.00-00           237  37307   603    250 L2  0000.0000.0161.00-00  <>
      LSP generation remaining wait time: 0 ms
      Time remaining until refresh: 303 s
      NLPID: 0x8E(IPv6)
      ...
      Router Capabilities: Router Id: 100.0.0.161 Flags: []
        ...
        SRv6 Capability: Flags: []
    JNPR-307-ACX7024.00-00      1531  36516  1181    675 L2  0000.0000.0307.00-00  <>
      NLPID: 0x8E(IPv6)
    ...
    JNPR-310-ACX7100-48L.00-00     12151  18386  1197    797 L2  0000.0000.0310.00-00  <>
      NLPID: 0x8E(IPv6)
      ...
      Router Capabilities: Router Id: 10.0.1.10 Flags: []
        ...
        Flex Algo: Algorithm: 129 Metric: TE Metric (2) Calc: SPF (0) Prio: 0
      Unsupported TLV: Type: 14 Length: 2
    JNPR-316-MX304.00-00       1235  24492  1097    795 L2  0000.0000.0316.00-00  <>
      NLPID: 0x8E(IPv6)
      ...
      Router Capabilities: Router Id: 10.0.1.16 Flags: []
        ...
        Flex Algo: Algorithm: 129 Metric: TE Metric (2) Calc: SPF (0) Prio: 0
      Unsupported TLV: Type: 14 Length: 2
    ZTE_336_ZXR10_M6000-8SE.00-00      3021  48351  1179   1198 L2  0000.0000.0336.00-00  <>
      NLPID: 0xCC(IPv4) 0x8E(IPv6)
    ...
    Cisco342-9902.00-00         302  61020   564    563 L2  0000.0000.0342.00-00  <>
      NLPID: 0x8E(IPv6)
      ...
      Router Capabilities: Router Id: 0.0.0.0 Flags: []
        ...
        Algorithms:  0, 1, 128
      Unsupported TLV: Type: 14 Length: 2
    Cisco352-N540.00-00         288  45713   569    943 L2  0000.0000.0352.00-00  <>
      NLPID: 0x8E(IPv6)
      ...
      Router Capabilities: Router Id: 0.0.0.0 Flags: []
        ...
        Algorithms:  0, 1, 128
      Unsupported TLV: Type: 14 Length: 2
    Cisco353-8201-24H8FH.00-00      2382  47384   653    999 L2  0000.0000.0353.00-00  <>
      NLPID: 0x8E(IPv6)
      ...
      Router Capabilities: Router Id: 0.0.0.0 Flags: []
        ...
        Flex Algo: Algorithm: 128 Metric: Min Unidirectional Delay Metric (1) Calc: SPF (0) Prio: 128
      Unsupported TLV: Type: 14 Length: 2
    Nokia_58-SR1-3-SRv6.00-00      1419   6671 65463    707 L2  0100.0000.0058.00-00  <>
      NLPID: 0xCC(IPv4) 0x8E(IPv6)
      ...
      SRv6 Locator: fcbb:1:1302::/48 Topology: 0
        Metric: 1033 Algorithm: 128 Flags: []
        SRv6 SID End with NEXT-CSID PSP USP USD
          SID : fcbb:1:1302::
          SID structure: Block length: 32 Node length: 16
                         Function length: 0 Argument length: 80
      SRv6 Locator: fcbb:1:1344::/48 Topology: 0
        Metric: 21032 Algorithm: 128 Flags: []
        SRv6 SID End with NEXT-CSID PSP USD
          SID : fcbb:1:1344::
          SID structure: Block length: 32 Node length: 16
                         Function length: 0 Argument length: 80
      SRv6 Locator: fcbb:1:1353::/48 Topology: 0
        Metric: 984 Algorithm: 128 Flags: []
        SRv6 SID End with NEXT-CSID PSP USD
          SID : fcbb:1:1353::
          SID structure: Block length: 32 Node length: 16
                         Function length: 0 Argument length: 80
      Router Capabilities: Router Id: 10.0.0.58 Flags: []
        ...
        SRv6 Capability: Flags: []
        Algorithms:  0, 128
    Nokia_58-SR1-3-SRv6.00-01      4181  32353 65524   1180 L2  0100.0000.0058.00-01  <>
      IS Neighbor          : JNPR-310-ACX7100-48L.00 Metric: 10
      ...
      SRv6 Locator: fcbb:1:1199::/48 Topology: 0
        Metric: 11032 Algorithm: 128 Flags: []
        SRv6 SID End with NEXT-CSID PSP USD
          SID : fcbb:1:1199::
          SID structure: Block length: 32 Node length: 16
                         Function length: 0 Argument length: 80
      ...
      SRv6 Locator: fcbb:1:1338::/48 Topology: 0
        ...
        SRv6 SID End with NEXT-CSID PSP
          ...
          SID structure: Block length: 32 Node length: 16
                         Function length: 0 Argument length: 80
    Nokia-59-IXRe2.00-00        394  10244  1070    883 L2  0100.0000.0059.00-00  <>
      NLPID: 0xCC(IPv4) 0x8E(IPv6)
      ...
      Router Capabilities: Router Id: 10.0.0.59 Flags: []
        ...
        Algorithms:  0, 128, 129, 130, 131
    Keys-Ixia-419.00-00         462  20512   658    351 L2  3800.0000.0419.00-00  <DefaultAtt>
...
24.161.225.225    1:09:54  0020.0100.0001  Vlan24, Ethernet11
```
...
----    -----------       ----        -----      -----   ---------
  24    0020.0100.0001    DYNAMIC     Et11       1       0:17:05 ago
